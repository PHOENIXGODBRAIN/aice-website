...
import { 
  ...
  FileText, Activity, Building2, Lock
} from 'lucide-react';
      ...
      <div className="max-w-[85rem] mx-auto relative z-10">
        ...
        <div className="mb-20 animate-in slide-in-from-bottom-4 duration-700 flex flex-col items-center text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-400 font-light max-w-3xl mx-auto leading-relaxed border-l-4 border-[#00F3FF] pl-6 text-left">
              A.I.C.E. Systems Corp. is a Canadian B2B software company. We engineer autonomous governance protocols to help reduce instability and operational risk in complex digital infrastructure.
            </p>
        </div>

        {/* COMPLIANCE TRANSLATION MATRIX (PLAIN ENGLISH FOR WISE/BANKS) */}
        <div className="mb-24 bg-[#050505] border border-white/10 rounded-3xl overflow-hidden shadow-2xl relative animate-in slide-in-from-bottom-8 duration-700 delay-100 group hover:border-[#00F3FF]/30 transition-colors">
            ...
            <div className="bg-white/5 border-b border-white/10 p-4 md:p-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <span className="font-mono text-xs md:text-sm font-bold text-[#00F3FF] tracking-[0.2em] uppercase">Executive Translation Matrix // Plain English</span>
                </div>
                <span className="font-mono text-[10px] text-gray-500 tracking-widest hidden md:block">COMPLIANCE DECRYPTION ACTIVE</span>
            </div>
            ...
            <div className="p-8 md:p-12 grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div>
                    ...
                    <p className="text-gray-300 leading-relaxed mb-6 font-light text-lg">
                        We are a Business-to-Business (B2B) Software-as-a-Service (SaaS) provider. We build and license autonomous monitoring software that protects large-scale corporate networks (like data centers and AI models) from crashing.
                    </p>
                    <p className="text-gray-300 leading-relaxed font-light text-lg">
                        When a client's system begins to fail or act unpredictably, our software detects the anomaly and automatically applies stabilizing algorithms to prevent costly downtime.
                    </p>
                </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-4">
                                <div className="p-1.5 rounded-full bg-[#00FF66]/10 border border-[#00FF66]/30 mt-1"><FileText size={14} className="text-[#00FF66]" /></div>
                                <span className="text-gray-300 font-light text-lg">A comprehensive PDF report analyzing the client's system failure logs.</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="p-1.5 rounded-full bg-[#00FF66]/10 border border-[#00FF66]/30 mt-1"><Activity size={14} className="text-[#00FF66]" /></div>
                                <span className="text-gray-300 font-light text-lg">A quantified breakdown of financial losses caused by system inefficiencies.</span>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="p-1.5 rounded-full bg-[#00FF66]/10 border border-[#00FF66]/30 mt-1"><Cpu size={14} className="text-[#00FF66]" /></div>
                                <span className="text-gray-300 font-light text-lg">An executive action plan for integrating our software to reduce future risk.</span>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        {/* EXECUTIVE LEADERSHIP (THE HUMAN ELEMENT) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24 animate-in slide-in-from-bottom-8 duration-700 delay-200">
            ...
            <div className="lg:col-span-7 bg-gradient-to-br from-[#050505] to-black border border-white/10 rounded-3xl p-10 md:p-12 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden group hover:border-orange-500/30 transition-colors">
                ...
                <div className="inline-flex items-center gap-3 px-4 py-2 border border-orange-500/30 bg-orange-500/10 rounded-sm mb-8">
                    ...
                    <span className="text-orange-500 font-mono text-xs font-bold uppercase tracking-widest">Executive Leadership // Level 1</span>
                </div>
                
                <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter mb-2">Shaun Randal Deeves</h2>
                <h3 className="text-xl text-[#00F3FF] font-mono tracking-widest uppercase mb-8">Founder & Chief Architect</h3>
                
                <div className="space-y-6 text-gray-300 font-light text-lg leading-relaxed relative z-10">
                    <p>
                        As the principal engineer and founder of A.I.C.E. Systems Corp., Shaun Deeves architects the deterministic frameworks that govern our software ecosystem. 
                    </p>
                    <p>
                        Specializing in algorithmic risk mitigation and entropic system stability, he leads the development of the Deviance Viscosity Stabilizer (DVS) technology, ensuring that enterprise clients maintain rigorous operational control over high-velocity digital environments.
                    </p>
                </div>
            </div>
            ...
            <div className="lg:col-span-5 bg-black/80 backdrop-blur-xl border border-white/10 rounded-3xl p-10 md:p-12 shadow-2xl relative flex flex-col justify-center">
                ...
                <ul className="space-y-6 font-mono text-sm md:text-base">
                    ...
                    <li className="flex flex-col">
                        ...
                        <span className="text-gray-300 tracking-wider">200 Edgar Ln<br/>Sherwood Park, AB T8H 2X6<br/>Canada</span>
                    </li>
                </ul>
        ...
        {/* THE CORE MISSION (ELEGANT & GROUNDED) */}
        <div className="mt-24 mb-12 relative animate-in slide-in-from-bottom-10 duration-1000 delay-300">
            ...
            <div className="text-center relative z-10">
                <div className="inline-flex items-center gap-3 px-4 py-2 border border-white/20 bg-white/5 rounded-full mb-6 shadow-inner">
                    ...
                    <span className="text-[#00F3FF] font-mono text-xs font-bold uppercase tracking-[0.2em]">Operational Mandate</span>
                </div>
                ...
                <div className="max-w-4xl mx-auto bg-[#050505]/90 border-t-2 border-[#00F3FF] p-8 md:p-12 rounded-2xl shadow-[0_0_30px_rgba(0,243,255,0.1)]">
                    ...
                    <p className="text-lg md:text-xl text-gray-400 font-light leading-relaxed">
                        We engineer the deterministic frameworks that allow enterprise systems to scale more reliably under stress.
                    </p>
                </div>
            </div>
        </div>
